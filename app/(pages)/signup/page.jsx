...
function signup() {
  return (
    <div>
      <div className="flex min-h-full flex-col justify-center px-6 py-7 lg:px-8 text-white">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <img
            ...
            alt="Your Company"
          />
          <h2 className="mt-3 text-center text-2xl font-medium leading-9 tracking-tight text-white">
